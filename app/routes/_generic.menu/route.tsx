...
export const meta: MetaFunction = () => {
  return [
    { title: `Menu | Josh & Nathan's Wedding` },
...
export default function Menu() {
  return (
    <div>
      <h1>Menu</h1>
      <p>
        One of the most important parts of a wedding, is what to eat. We both
        dislike sit-down traditional meals. We loved the idea of something dirty
        and delicious, which is why we chose the menu below. We hope you enjoy
        it as much as we do.
      </p>
      <p>
        Note: Please contact us for any dietry requirements that are not met
      ...
      <p>
        There will be various desserts for everyone, served on a dessert table,
        it will include:
      </p>
      <ul>
        ...
        <li>
          Chocolate Fountain with strawberries, banana, and marshmellows for
          dipping
        </li>
      </ul>
      <h1>Drinks</h1>
      <p>
        We wanted to keep the drinks as simple as possible. We will provide a
        few options
      </p>
      <ul>
        <li>Beer (Single Brand - To be decided)</li>
        <li>Apple Cider</li>
        <li>Soft Drinks</li>
        <li>Water</li>
      </ul>
      <p>
        Spirits and other alcohol is allowed, but guests should bring their own
        (BYO) - we will provide the ice and cups ;)
      </p>
    </div>
  )
}
